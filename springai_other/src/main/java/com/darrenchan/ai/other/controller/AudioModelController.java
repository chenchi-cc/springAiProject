package com.darrenchan.ai.other.controller;
...
public class AudioModelController {
    ...
    private static final String PATH = "/Users/chenchi03/IdeaProjects/springAiProject/springai_other/src/main/resources/tts";
    ...
    public void tts() {
        ...
        File file = new File(PATH + "/read.mp3");
